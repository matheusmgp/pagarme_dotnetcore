...
namespace Domain.Entities
{
    public class TransactionEntity: BaseEntity
    {
        ...
        public static TransactionEntity CreateEntity(double price, DateTime cardExpiresDate, string description, string paymentMethod, string cardNumber,
             string ownerName, int cvv)
        {
            return new TransactionEntity(price, cardExpiresDate, description, paymentMethod, cardNumber, ownerName, cvv);
